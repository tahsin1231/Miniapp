...
━━━━━━━━━━━━━━━━━━━━━`,
      ...
      const unsub = onSnapshot(userRef, async (docSnap) => {
        if (docSnap.exists()) {
          ...
          const initialData: UserData = {
            ...
            currentAdCount: 0,
            isBanned: false,
            isAdmin: tgUser?.id.toString() === '6465729271',
  ...
  const handleWatchAd = async () => {
    ...
    try {
      ...
      await new Promise(resolve => setTimeout(resolve, isNextUnique ? 10000 : 5000));
      
      const userRef = doc(db, 'users', user.uid);
      
      if (isNextUnique) {
        // Unique Ad Logic: User must click and register
        // For simulation, we show a message and wait for a "Verify" action or just credit after a delay
        // Here I'll just credit it but with a longer delay and a specific message
          ...
          {activeTab === 'profile' && (
            ...
            >
              ...
              <div className="grid gap-4">
                ...
                { (tgUser?.id.toString() === '6465729271' || userData?.isAdmin) && (
                  <a 
                    href="/admin.html" 
